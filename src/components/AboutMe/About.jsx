  ...
  return (
    <section className="relative flex items-center justify-center">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-purple-500/5 rounded-full blur-lg animate-bounce" />
      </div>
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-[.5fr_1fr] gap-12 items-center">
        {/* Left side - Image and visual elements */}
          ...
          <div className="w-full flex justify-start max-sm:justify-center">
            <div className="relative h-100 w-90 max-sm:h-60 max-sm:w-60">
              ...
              />
              <div className="absolute -bottom-4 -right-4 bg-purple-500 text-white px-4 py-2 rounded-full font-serif font-bold text-sm shadow-lg">
                ¡Hola! 👋
              </div>
            </div>
          </div>
        ...
        <div className="space-y-8">
          ...
          <div className="leading-relaxed font-normal text-[18px] text-gray-800 max-sm:text-lg min-sm:text-start flex flex-col gap-3">
            <p>
              Hola, soy <span className="text-purple-500 font-semibold">Yonier García Mosquera</span>, Ingeniero de
          ...
          <div className="w-1/2 grid grid-cols-2 gap-4">
              ...
              <a href="/cv/Yonier_Garcia_Mosquera_cv.pdf" download="Yonier_Garcia_Mosquera_cv.pdf" className="text-white text-center bg-black hover:opacity-85 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none dark:focus:ring-indigo-800">
              CV
              </a>
       
            <Link className="cursor-pointer text-indigo-500 hover:text-white border border-indigo-500 hover:bg-indigo-500 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" to="/contacto">
              Contactar
            </Link>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6 pt-8 border-t border-gray-200">
            <div className="text-center">
              <div className="text-3xl font-serif font-bold text-purple-500">∞</div>
